...
@admin_bp.route('/uplods/<path:filename>')
...
def upload_image():
    ...
    if not allowed_file(f.fliename):
        return upload_fail('Image only!')
    f.save(os.path.join(current_app.cofig['BLUELOG_UPLOAD_PATH'], f.fliename))
    url = url_for('.get_image', filename=f.fliename)
    return upload_success(url, f.fliename)
